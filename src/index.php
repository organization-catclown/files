        ...
        <div class="l-modal__body l-flex u-fill" id="js-enter_body">
          ...
          <section class="l-modal__page">
            ...
            <div class="c-textBox c-textBox--firstName u-mt50" id="js-first_name">
              <input tabindex="-1" name="r_firstName" type="text" class="c-textBox" id="rfirst_name"
                onclick="SetTargetC('rfirst_name')" required="required" oncopy="return false" onpaste="return false"
                oninput="checkKey(this)" onfocus="blur()">
            ...
            <div class="c-textBox c-textBox--lastName u-mt50" id="js-last_name">
              <input tabindex="-1" name="r_lastName" type="text" class="c-textBox" id="rlast_name"
                onclick="SetTargetC('rlast_name')" required="required" oncopy="return false" onpaste="return false"
                oninput="checkKey(this)" onfocus="blur()" />
          ...
          <div class="l-modal__page">
            ...
            <div class="c-textBox c-textBox--teacherCode u-mt50">
              <input tabindex="-1" name="r_entryTeacherCode" type="text" class="c-textBox" id="rteacher_code" onclick="SetTargetN('rteacher_code')"
                required="required" oncopy="return false" onpaste="return false" oninput="checkKey(this)"
                onfocus="blur()" />
              <div class="border-v">
                <div class="border-h"></div>
              </div>
        ...
        <div class="l-modal__body l-flex u-fill" id="js-exit_body">
          ...
          <section class="l-modal__page">
            ...
            <div class="c-textBox c-textBox--firstName u-mt50" id="js-exit_firstName">
              <input tabindex="-1" name="l_firstName" type="text" class="c-textBox" id="lfirst_name"
                onclick="SetTargetC('lfirst_name')" required="required" oncopy="return false" onpaste="return false"
                oninput="checkKey(this)" onfocus="blur()" />
            ...
            <div class="c-textBox c-textBox--lastName u-mt50" id="js-llastName">
              <input tabindex="-1" name="l_lastName" type="text" class="c-textBox" id="llast_name"
                onclick="SetTargetC('llast_name')" required="required" oncopy="return false" onpaste="return false"
                oninput="checkKey(this)" onfocus="blur()" />
      ...
      <div class="l-directionColumn u-hFill ">
        ...
        <div class="l-modal__body l-flex u-fill" id="js-teacherbody">
          <section class="l-modal__page">
            <div class="c-label">教員番号を入力してください</div>
            <div class="c-textBox c-textBox--teacherCode u-mt50">
              <input tabindex="-1" type="text" class="c-textBox" onclick="SetTargetN('teacher_code')"
                required="required" oncopy="return false" onpaste="return false" oninput="checkKey(this)"
                onfocus="blur()" />
              <div class="border-v">
                <div class="border-h"></div>
